...
using Wpf_DualCam_SpDriving.RawFramesDecoding;
using Wpf_DualCam_SpDriving.RawFramesDecoding.DecodedFrames;
using PixelFormat = Wpf_DualCam_SpDriving.RawFramesDecoding.PixelFormat;

namespace Wpf_DualCam_SpDriving.GUI.Views
{
    /// <summary>
